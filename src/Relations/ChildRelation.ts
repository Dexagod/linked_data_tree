export enum ChildRelation{
    ...
    LesserOrEqualThanRelation="LesserOrEqualThanRelation",
    EqualThanRelation="EqualThanRelation",
    GeospatiallyContainsRelation="GeospatiallyContainsRelation",
    InBetweenRelation="InBetweenRelation"
}